...
import mehagarg.android.twitterapp.BuildConfig;
import mehagarg.android.twitterapp.R;

import java.util.ArrayList;
import java.util.List;

import mehagarg.android.twitterapp.YambaApplication;
...
public class YambaLogic {
    ...
    public void doPost(String tweet) {
        int msg = R.string.tweet_sent;
        try {
            ((YambaApplication) ctxt.getApplicationContext()).getClient().postStatus(tweet);
